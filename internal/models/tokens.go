...
// Token Add struct tags to control how the struct appears when encoded to JSON.
type Token struct {
...
// ValidateTokenPlaintext Check that the plaintext token has been provided and is exactly 52 bytes long.
